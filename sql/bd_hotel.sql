...
CREATE TABLE reservaciones(
    ...
    fk_id_cli_reserv INT AUTO_INCREMENT,
...
CREATE TABLE pagos_cli(
    ...
    fk_id_cli_pago INT AUTO_INCREMENT,
    fk_id_id_reserv_pago INT AUTO_INCREMENT,
    clinte_saldo INT,
    cliente_pago INT,
    PRIMARY KEY (id_pago),
...
CREATE TABLE admin_hotel (
    ...
    fk_id_cli_adm INT AUTO_INCREMENT, 
    fk_id_reserv_adm INT AUTO_INCREMENT,
    ganancias_admin INT,
    hab_reservadas INT,
