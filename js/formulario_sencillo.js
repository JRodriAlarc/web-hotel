...
function calcularDiasYPrecio(e) {
    ...
    btn_comprar.addEventListener('click', function(e){
        ...
        console.log(input__numero_persona.value + ' ' + select_tipo_habitacion.value + ' ' + fechaEntrada.value, + ' ' +  fechaSalida.value + '' + span_PrecioTotal.value + '' + span_PrecioNoche.value);
        ...
        fetch("../web-hotel/php/hotel_hab_reservadas", {  
            ...
            body: JSON.stringify({                 
                ...
                _fecha_ingreso: fechaEntrada.value,
                _fecha_salida: fechaSalida.value,
                _total_pagar: span_PrecioTotal.value,
                _precio_noche: span_PrecioNoche.value
            })
        })                                              
